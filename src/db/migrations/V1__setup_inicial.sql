CREATE TABLE protocolo (
  ...
  cantidad_regimenes NUMBER NOT NULL
);
...
CREATE TABLE receta_detalle (
  ...
  dosis_diaria       VARCHAR2(50),
  numero_dias        NUMBER,
  dosis_total        NUMBER,
  dosis_unidad       VARCHAR2(10),
...
-- Configuración para el sistema de alarmas de vencimiento de recetas
CREATE TABLE configuracion_alarma (
  configuracion_id   NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  limite_dias        NUMBER NOT NULL CHECK (limite_dias > 0),
  ultima_ejecucion   TIMESTAMP
);

-- Insertamos configuración por defecto: límite de 14 días (2 semanas)
INSERT INTO configuracion_alarma (limite_dias) VALUES (14);

-- Tabla de alarmas de vencimiento de recetas
-- Esta tabla se regenera diariamente por un job
CREATE TABLE alarmas (
  alarma_id           NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  paciente_id         NUMBER NOT NULL,
  fecha_ultima_receta DATE NOT NULL,
  dias_transcurridos  NUMBER NOT NULL,
  CONSTRAINT fk_alarma_paciente FOREIGN KEY (paciente_id) REFERENCES paciente(paciente_id)
);
