...
async function crearPaciente(req, res, service) {
  try {
    ...
    const { nombre, apellido, id_hospitalario, fecha_nacimiento, peso, altura, sexo, obra_social} = req.body;
    ...
    const paciente = new Paciente(nombre, apellido, id_hospitalario, fecha_nacimiento_date, peso, altura, sexo, obra_social);
