Feature: Asignar y consultar protocolos de un paciente
  ...
  Background:
    Given existe en la base de datos un profesional con id "5" llamado "Dr. García"
    ...
    And existe en la base de datos un paciente con id "12" llamado "Marcos Pérez"

  Scenario: US-08.1 Asignar un protocolo a un paciente
  ...
  Scenario: US-08.4 Error por FK: paciente inexistente
    Given quiero asignar a un paciente un protocolo con los siguientes datos
      | protocolo_id            | 1 |
      | regimen                 | 0 |
      | ciclo_actual_id         | 1 |
  ...
  Scenario: US-08.5 Error por FK: ciclo inexistente
    Given quiero asignar a un paciente un protocolo con los siguientes datos
      | protocolo_id            | 1 |
      | regimen                 | 0 |
      | ciclo_actual_id         | 99 |
  ...
  @wip
  Scenario: US-08.6 Conflicto por duplicado (mismo protocolo/regimen ya asignado)
  ...
  Scenario: US-08.7 Obtener un protocolo específico de un paciente
    Given existe en la base de datos un protocolo asignado al paciente con id "12" con los siguientes datos
      | protocolo_id            | 1        |
      | regimen                 | 0        |
      | ciclo_actual_id         | 1        |
